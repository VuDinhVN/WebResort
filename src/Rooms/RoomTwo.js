...
const RoomTwo = () => {
    return (
        <div style={{fontFamily: 'AssistantRegular', display: 'flex', flexDirection: 'row', alignItems: 'center', flexDirection: 'column' }}>
            <span style={{fontFamily: 'AssistantRegular', marginTop: 10, marginBottom: 10, fontSize: 20, fontWeight: 'bold', width: '92%' }}>Double or Twin Riverview Bungalow</span>
            <div style={{fontFamily: 'AssistantRegular', display: 'flex', width: '92%', marginBottom: 20, marginTop: 10, }}>
                ...
                >
                    <div style={{fontFamily: 'AssistantRegular', flexDirection: 'column', width: '100%' }}>
                        <span styles={{fontFamily: 'AssistantRegular'}}>Contact</span>
                    ...
                    <div style={{fontFamily: 'AssistantRegular', display: 'flex', flexDirection: 'column', width: '100%' }}>
                        <span styles={{fontFamily: 'AssistantRegular'}}>Address</span>
                        <span styles={{fontFamily: 'AssistantRegular'}}>Mekong Riverside Boutique Resort & Spa,
                        </span>
                    ...
                    <div style={{fontFamily: 'AssistantRegular', display: 'flex', flexDirection: 'column', width: '100%' }}>
                        <span styles={{fontFamily: 'AssistantRegular'}}>Phone</span>
