        ...
        <div style={{ 
            ...
            <div style={{ flex: 3, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                ...
                <div style={{  display: 'flex', flexDirection: 'row', marginRight: 10,fontStyle: 'italic', }}>
                   ...
                   <a className = "font"  href="tel:+84336132135" style={{ color: '#2d6331', fontStyle: 'italic',}}>+84 336 132 135</a>
                </div>
                <div style={{  display: 'flex', flexDirection: 'row', marginLeft: 10,fontStyle: 'italic', }}>
                    <span className = "font"  style={{  color: '#2d6331' }}>
                        Email:&ensp;
                    </span >
                   <a className = "font"  href="mailto:lichvutravel@yahoo.com" style={{ color: '#2d6331', fontStyle: 'italic',}}>lichvutravel@yahoo.com</a>
                </div>
                <div style={{  display: 'flex', flexDirection: 'row', marginLeft: 10,fontStyle: 'italic', }}>
                    <span className = "font"  style={{  color: '#2d6331' }}>
                        Sales:&ensp;
                    </span >
                   <a className = "font"  href="mailto:info@dulichdongduong.com" style={{ color: '#2d6331', fontStyle: 'italic',}}>info@dulichdongduong.com</a>
                </div>
    ...
    return (
        <div style={{ 
            ...
            <div style={{  display: 'flex', paddingTop: 10, paddingBottom: 10 }}>
                <span className = "font"  style={{  fontSize: 20, fontWeight: 'bold', color: 'white' }}>Book your stay</span>
            </div>
            <div style={{  display: 'flex', flexDirection: 'row', justifyContent: 'space-around', width: '100%' }}>
                <div style={{  display: 'flex', flexDirection: 'column', paddingBottom: 10, alignItems: 'flex-start' }}>
                    <span className = "font"  style={{  color: 'white', fontWeight: 'bold', fontSize: 17 }}>Check in</span>
                ...
                <div style={{  display: 'flex', flexDirection: 'column', paddingBottom: 10, alignItems: 'flex-start' }}>
                    <span className = "font"  style={{  color: 'white', fontWeight: 'bold', fontSize: 17 }}>Check out</span>
                    <div style={{  display: 'flex', flexDirection: 'row', padding: 10, border: '2px solid white', borderRadius: 5 }}>
            ...
            <div style={{  paddingBottom: 5, display: 'flex', flex: 1, flexDirection: 'row', justifyContent: 'space-around', width: '100%' }}>
                <div style={{ }}>
                    <span className = "font"  style={{  color: 'white', fontWeight: 'bold', fontSize: 17 }}>Adults</span>
                    <div style={{ 
                        paddingBottom: 10,
                        paddingTop: 10,
                        paddingLeft: 20,
                        ...
                        <span className = "font"  style={{  color: 'white', fontWeight: 'bold', fontSize: 17 }}>{au}</span>
                ...
                <div style={{ }}>
                    <span className = "font"  style={{  color: 'white', fontWeight: 'bold', fontSize: 17 }}>Children</span>
                    <div style={{ 
                        paddingBottom: 10,
                        paddingTop: 10,
                        paddingLeft: 20,
                        ...
                        <span className = "font"  style={{  color: 'white', fontWeight: 'bold', fontSize: 17 }}>{ch}</span>
                ...
                <div style={{ }}>
                    <span className = "font"  style={{  color: 'white', fontWeight: 'bold', fontSize: 17 }}>Infant</span>
                    <div style={{ 
                        paddingBottom: 10,
                        paddingTop: 10,
                        paddingLeft: 20,
                        ...
                        <span className = "font"  style={{  color: 'white', fontWeight: 'bold', fontSize: 17 }}>{ifa}</span>
