		...
		<div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%' }}>
			...
			<div style={{
				...
				<div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', flex: 1, marginRight: '20%', marginLeft: '20%', backgroundColor: 'rgba(53,51,49,0.5)', }}>
					...
					<span style={{color: 'white', textAlign: 'center', paddingBottom: 10, marginLeft: 20, marginRight: 20}}>Các phòng theo phong cách bungalow của chúng tôi kết hợp với vẻ đẹp thẩm mỹ của khu nghỉ dưỡng của chúng tôi đưa bạn vào trạng thái thư giãn của đồng bằng sông Cửu Long</span>
