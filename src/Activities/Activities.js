    ...
    return (
        <AppContainer>
            ...
            <div style={{fontFamily: 'AssistantRegular', position: 'relative', textAlign: 'center', color: 'red', height: 450, marginTop: 59 }}>
                <img src='https://myguestdiary-cdn-uploads.azureedge.net/uploads/1079/__page__110347987_1965548800253752_4120832034334431246_o.jpg?width=1920&height=670&mode=crop' style={{fontFamily: 'AssistantRegular', height: 300, width: '100%' }}></img>
